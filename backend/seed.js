...
async function seed() {
  ...
  /* ── Admin ── */
  const admin = await Admin.create({ name: 'Admin', email: 'devintyagi471@gmail.com', password: 'TerabaapAdmin@471' });
  ...
  console.log('   Admin:    devintyagi471@gmail.com / TerabaapAdmin@471\n');
  process.exit(0);
}
